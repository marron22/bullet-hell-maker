...
function applyPolynomialRadial(event: AttackEvent & BulletMotionFields & FireClipFields, stage: StageSize): void {
  ...
  event.originY = stage.height / 2;
  event.pathSpeed = 180;
  event.polynomialA = -0.35;
  event.polynomialB = 0.18;
  event.polynomialC = -0.02;
  event.polynomialD = 0;
  event.polarTheta = -90;
...
function applyCurvedLaserRing(event: AttackEvent & BulletMotionFields & FireClipFields, stage: StageSize): void {
  ...
  event.originY = stage.height / 2;
  event.pathSpeed = 190;
  event.polynomialA = -0.18;
  event.polynomialB = 0.11;
  event.polynomialC = -0.01;
  event.polynomialD = 0;
  event.polarTheta = 0;
  event.polarThetaVelocity = 18;
  event.typeId = 4;
  event.visualPreset = "laser";
  event.visualSize = 6;
  event.visualWidth = 280;
  event.visualHeight = 10;
  event.visualAngle = 0;
  event.aimAtPlayer = 0;
  event.clipCount = 8;
  event.clipRepeat = 1;
